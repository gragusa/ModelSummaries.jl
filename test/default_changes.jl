...
function ModelSummaries.default_digits(
        ::ModelSummaries.AbstractRenderType, x::ModelSummaries.AbstractRegressionStatistic)
    4
end
...
function ModelSummaries.default_digits(render::ModelSummaries.AbstractRenderType,
        x::ModelSummaries.AbstractRegressionStatistic)
    ModelSummaries.default_digits(render, ModelSummaries.value(x))
end

##
# Test default_digits for AbstractUnderStatistic (Ascii only)
function ModelSummaries.default_digits(::ModelSummaries.AbstractAscii, x::ModelSummaries.AbstractUnderStatistic)
    4
end
tab = modelsummary(rr1, rr2, rr3, rr4, rr5, rr6, rr7; stars = true)
@test tab[2, 2] == "6.526***" # rr1 intercept coefficient
...
function ModelSummaries.default_digits(
        render::ModelSummaries.AbstractAscii, x::ModelSummaries.AbstractUnderStatistic)
    ModelSummaries.default_digits(render, ModelSummaries.value(x))
end

##
# Test default_digits for CoefValue (2 digits)
function ModelSummaries.default_digits(::ModelSummaries.AbstractRenderType, x::ModelSummaries.CoefValue)
    2
end
...
function ModelSummaries.default_digits(render::ModelSummaries.AbstractRenderType, x::ModelSummaries.CoefValue)
    ModelSummaries.default_digits(render, ModelSummaries.value(x))
end
...
tab = modelsummary(
    rr1, rr2, rr3, rr4, rr5, rr6, rr7; stars = true, number_regressions = false)
...
tab = modelsummary(
    rr1, rr2, rr3, rr4, rr5, rr6, rr7; labels = Dict("SepalLength" => "Sepal Length"))
...
tab = modelsummary(
    rr1, rr2, rr3; regression_statistics = [Nobs, R2, FStatPValue], backend = :latex)
