...
begin
    ...
    rr3 = reg(df, @formula(SepalLength ~
                           SepalWidth + PetalLength + PetalWidth + fe(SpeciesDummy)))
    rr4 = reg(df, @formula(SepalWidth ~
                           SepalLength + PetalLength + PetalWidth + fe(SpeciesDummy)))
end
...
regtable(rr1, rr2, rr3, rr4; render = AsciiTable())
...
regtable(rr1, rr2, rr3, rr4; render = HtmlTable())
